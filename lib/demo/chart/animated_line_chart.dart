...
import 'common/animated_path_util.dart';
import 'common/datetime_chart_point.dart';
import 'common/pair.dart';
import 'common/text_direction_helper.dart';
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      onTapDown: (tap) {
        ...
        _horizontalDragPosition = tap.localPosition.dx;
        setState(() {});
      },
      onHorizontalDragStart: (dragStartDetails) {
        _horizontalDragActive = true;
        _horizontalDragPosition = dragStartDetails.localPosition.dx;
        setState(() {});
      },
